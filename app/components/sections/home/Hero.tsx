...
export default function Hero() {
  ...
  return (
    <div className="bg-[#2b5b76] w-full min-h-[41.87rem] rounded-br-[4rem] sm:rounded-br-[6rem] lg:rounded-br-[10rem] flex justify-center items-center py-16 px-4 sm:px-8">
      <div className="w-full max-w-5xl flex flex-col justify-center items-start text-white gap-10">
